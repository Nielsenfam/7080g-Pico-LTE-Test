...
def mqtt_test():
    ...
    #send_at('AT+SMSUB=\"channels/'+str(ts_channel)+'/subscribe",1','OK',5000)
    send_at('AT+SMPUB=\"channels/'+str(ts_channel)+'/publish\",' + str(mqtt_msg_len) + ',1,1','OK',2000)
    Pico_SIM7080G.write(mqtt_msg.encode())
    utime.sleep(2);
    #send_at('AT+SMUNSUB=\"channels/2284940/subscribe\"','OK',2000)
...
#print("sleeping for " +str(sample_min)+ " mins\n")
#machine.deepsleep(sample_min*1000)
